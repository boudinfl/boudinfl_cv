\item
Juan Junqueras, \textbf{Florian Boudin}, May Myo Zin, Ha Thanh Nguyen, Wachara Fungwacharakorn, Damián Ariel Furman, Akiko Aizawa, Ken Satoh.
\href{https://arxiv.org/abs/2511.09575}{FC-CONAN: An Exhaustively Paired Dataset for Robust Evaluation of Retrieval Systems}.
\textit{Workshop on Next-Generation Language Models for Knowledge Representation and Reasoning (NeLaMKRR)}.
\label{junqueras-etal-2025-fc-conan}
...
2024.
\href{https://aclanthology.org/2024.acl-srw.55.pdf}{Automatically Suggesting Diverse Example Sentences for L2 Japanese Learners Using Pre-Trained Language Models}.
