\item
Xanh Ho, Yun-Ang Wu, Sunisth Kumar, \textbf{Florian Boudin}, Atsuhiro Takasu, Akiko Aizawa.
2026.
\href{https://arxiv.org/abs/2511.10075}{Format Matters: The Robustness of Multimodal LLMs in Reviewing Evidence from Tables and Charts}.
\textit{Annual AAAI Conference on Artificial Intelligence (AAAI)}.
\label{ho-etal-2026-format}

\item
Xanh Ho, Sunisth Kumar, Yun-Ang Wu, \textbf{Florian Boudin}, Atsuhiro Takasu, Akiko Aizawa.
2025.
\href{https://aclanthology.org/2025.findings-emnlp.135.pdf}{Table-Text Alignment: Explaining Claim Verification Against Tables in Scientific Papers}.
In Findings of the Conference on Empirical Methods in Natural Language Processing (EMNLP).
\label{ho-etal-2025-table}

\item 
Leane Jourdan, Nicolas Hernandez, \textbf{Florian Boudin}, Richard Dufour.
2025.
\href{https://aclanthology.org/2025.acl-long.335.pdf}{Identifying Reliable Evaluation Metrics for Scientific Text Revision}.
...
2025.
\href{https://link.springer.com/chapter/10.1007/978-3-031-97144-0_13}{Repurposing Annotation Guidelines to Instruct LLM Annotators: A Case Study}.
