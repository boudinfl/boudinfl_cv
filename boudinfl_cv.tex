...
LS2N \hfill \href{https://boudinfl.github.io/}{boudinfl.github.io/} \newline
...
\begin{description}
    ...
    \item[09/2025 -- present] \textbf{Researcher} - \emph{Chargé de Recherche (en détachement)}\\
                                Inria, France
...
\begin{description}
    ...
    \item[2004] \textbf{B.Sc. in Mathematics and Computer Science} \\
                Université d'Avignon et des Pays de Vaucluse, France \\
                Exchange year at the University of Birmingham, UK (ERASMUS Programme)

    \item[2000] \textbf{Scientific Baccalauréat} \\
                Lycée Roumanille, Nyons, France
